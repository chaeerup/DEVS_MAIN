...
<script type="text/javascript">
	...
	onload = function() {
		...
		$.getJSON('http://140.238.2.56:5000/crawling', function(data) {
			var rank = data.rank;
		...
		function fillFeedList(data){	
			...
			$.each(data, function(key, value){
				...
				var list_reply = $('<li>').attr({'class':'list_reply', 'style':'margin-right:15px;'});
				...
				$.ajax({
					...
					success: function(like){
						if(like.cnt){
							...
							list_like.append("<a class='like' id='"+board_code+"'>").append('<span class="icon regular fa-heart""></span>');
						}
					},
					error : function(){
